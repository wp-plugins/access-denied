...
if($access_denied_customer_type=="free")
	{
		echo '<p>You are using <strong> '.$access_denied_customer_type.' version  '.$access_denied_version.'</strong> of Woocommerce Products Slider, To get more feature you could try our premium version. ';
